...
class load_mySQL(object):
    def __init__(self):  
        ...
        self.label_testsd = ctk.CTkLabel(
            self.root, 
            text = "能力試驗標準差(選填):", 
            fg_color='#323232',
            text_font=('微軟正黑體',18),
        ...
        self.input_testsd = ctk.CTkEntry(
            self.root, 
            fg_color='#666666',
            text_color="#FFFFFF",
            width=150,height=35
    ...
    def clear_data(self):
        ...
        self.input_testsd.delete(0,"end")
    ...
    def gui_arrang(self):
        ...
        self.label_testval.place(relx=0.23,rely=0.7,anchor=tk.W)
        self.label_testsd.place(relx=0.12,rely=0.8,anchor=tk.W)
        ...
        self.input_testsd.place(relx=0.43,rely=0.8,anchor=tk.W)
        self.input_testobj.place(relx=0.45,rely=0.6,anchor=tk.W)
        self.button_back.place(relx=0.35,rely=0.9,anchor=tk.CENTER)
        self.button_OK.place(relx=0.65,rely=0.9,anchor=tk.CENTER)
